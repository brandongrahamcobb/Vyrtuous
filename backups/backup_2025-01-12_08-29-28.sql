...
CREATE TABLE public.tags (
    ...
    CONSTRAINT tags_tag_type_check CHECK (((tag_type)::text = ANY ((ARRAY['default'::character varying, 'loop'::character varying])::text[])))
);
...
1300517536001036348	1315735859848544378	t
\.
...
4	restaurantVegan	730907954345279591	**Been to a nice vegan or vegan-friendly restaurant recently? **\n🔹Write a Google or Yelp review with the keyword 'vegan' about your experience and what foods you had.\n🔹Share your opinion on the restaurant on Instagram or Facebook, bonus if you post in vegan/vegetarian Facebook groups.\n🔹Sign up for the **[Happy Cow](<https://www.happycow.net/>)** 🐮 💜  app to list the restaurant and leave a review to help others easily access veg options too.	\N	154749533429956608	loop
...
29	getActive	730907954345279591	**Willing to your get your hands dirty and be proactive for the animals?**\n🔹Consider doing direct action, attending vigils such as by the [Animal Save Movement](<https://thesavemovement.org/>), or get involved in pressure campaigns.\n🔹Get in contact with organizations such as [Direct Action Everywhere](<https://www.directactioneverywhere.com/>), [Animal Rebellion](<https://animalrebellion.org/about/>), [PETA](<https://www.peta.org/action/campaigns/>), and [Animal Liberation Front](<https://animalliberationfrontline.com/>)\n🔹**[Video](<https://www.youtube.com/watch?v=LHyqJxSeUFc>)** on the importance of pressure campaigns by [The Cranky Vegan](<https://www.instagram.com/the.cranky.vegan/?hl=en>) on [VeganFTA](<https://veganfta.com/>)	\N	259318132936671233	loop
\.
