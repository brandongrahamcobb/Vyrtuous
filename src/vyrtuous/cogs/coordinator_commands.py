...
class CoordinatorCommands(commands.Cog):
    ...
    async def create_moderator_app_command(
        ...
        channel_related_role = await is_owner_developer_administrator_coordinator(interaction, channel_obj, interaction.user)
    ...
    async def create_moderator_text_command(
        ...
        channel_related_role = await is_owner_developer_administrator_coordinator(ctx, channel_obj, ctx.author)
        if channel_related_role not in ('Owner', 'Developer', 'Administrator', 'Coordinator'):
