...
class Config:
    ...
    def get_config(cls) -> Dict[str, Any]:
        ...
        _config = {
            ...
            'discord_testing_guild_snowflake': int(os.environ['DISCORD_TESTING_GUILD_ID']),
            'discord_testing_first_channel_snowflake': int(os.environ['DISCORD_TESTING_FIRST_CHANNEL_SNOWFLAKE']),
            'discord_testing_second_channel_snowflake': int(os.environ['DISCORD_TESTING_SECOND_CHANNEL_SNOWFLAKE']),
