...
#             raise CheckFailure("This command must be executed inside a server.")
...
#                 user_index = moderator_service.PERMISSION_TYPES.index(user_highest)
#                 cmd_index = moderator_service.PERMISSION_TYPES.index(perm_level)
...
#         )
#         permission_groups = await self.group_commands_by_permission(all_commands)
...
#                 )
#                 perm_level_for_alias = alias_service.CATEGORY_TO_PERMISSION_LEVEL.get(
...
#             if moderator_service.PERMISSION_TYPES.index(perm_level) > user_index:
#                 continue
