...
base_cases = [
    ...
    # ("bans all", None, False, False, True),
    ...
    # ("flags all", None, False, False, True),
    ...
    # ("mutes all", None, False, False, True),
    # ("stages {voice_channel_one_id}", None, True, False, True),
