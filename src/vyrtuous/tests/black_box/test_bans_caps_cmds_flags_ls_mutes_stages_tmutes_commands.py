...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("alias flag testflag {voice_channel_one_id}", True, False, False),
        ("alias unflag testunflag {voice_channel_one_id}", True, False, False),
        ("testflag {member_id}", False, True, False),
        ("flags {voice_channel_one_id}", True, False, False),
        ("flags {member_id}", False, True, False),
        ("flags all", False, False, False),
        ("testunflag {member_id}", False, True, False),
        ("flags {voice_channel_one_id}", True, False, True),
        ("flags {member_id}", False, True, True),
        ("flags all", False, False, False),
        ("alias vegan testvegan {voice_channel_one_id}", True, False, False),
        ("alias carnist testcarnist {voice_channel_one_id}", True, False, False),
        ("testvegan {member_id}", True, False, False),
        ("ls {voice_channel_one_id}", True, False, False),
        ("ls {member_id}", False, True, False),
        ("ls all", False, False, False),
        ("testcarnist {member_id}", True, False, False),
        ("ls {voice_channel_one_id}", True, False, True),
        ("ls {member_id}", False, True, True),
        ("ls all", False, False, True),
        ("alias vmute testvm {voice_channel_one_id}", True, False, False),
        ("alias unvmute testunvm {voice_channel_one_id}", True, False, False),
        ("testvm {member_id}", True, False, False),
        ("mutes {voice_channel_one_id}", True, False, False),
        ("mutes {member_id}", False, True, False),
        ("mutes all", False, False, False),
        ("testunvm {member_id}", True, False, False),
        ("mutes {voice_channel_one_id}", True, False, True),
        ("mutes {member_id}", False, True, True),
        ("mutes all", False, False, True),
        ("stages {voice_channel_one_id}", True, False, False),
        ("stages all", False, False, True),
        ("alias tmute testtm {voice_channel_one_id}", True, False, False),
        ("alias untmute testuntm {voice_channel_one_id}", True, False, False),
        ("testtm {member_id}", True, False, False),
        ("tmutes {voice_channel_one_id}", True, False, False),
        ("tmutes {member_id}", False, True, False),
        ("tmutes all", False, False, False),
        ("testuntm {member_id}", True, False, False),
        ("tmutes {voice_channel_one_id}", True, False, True),
        ("tmutes {member_id}", False, True, True),
        ("tmutes all", False, False, True),
        ("cmds {voice_channel_one_id}", True, False, False),
        ("cmds all", False, False, False),
        ("xalias testban", True, False, False),
        ("xalias testunban", True, False, False),
        ("xalias testflag", True, False, False),
        ("xalias testunflag", True, False, False),
        ("xalias testvegan", True, False, False),
        ("xalias testcarnist", True, False, False),
        ("xalias testvm", True, False, False),
        ("xalias testunvm", True, False, False),
        ("xalias testtm", True, False, False),
        ("xalias testuntm", True, False, False),
        ("cmds {voice_channel_one_id}", True, False, True),
