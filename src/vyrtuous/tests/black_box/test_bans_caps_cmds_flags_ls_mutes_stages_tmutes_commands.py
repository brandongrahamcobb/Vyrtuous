...
base_cases = [
    # ("Administrator", "alias ban testban {voice_channel_one_id}", None, False, True, False, False),
    # ("Administrator", "alias unban testunban {voice_channel_one_id}", None, False, True, False, False),
    ("Moderator", "testban {member_id}", None, False, False, True, False),
    ...
    ("Moderator", "testunban {member_id}", None, False, False, True, False),
    ...
    # ("Administrator", "alias flag testflag {voice_channel_one_id}", None, False, True, False, False),
    # ("Administrator", "alias unflag testunflag {voice_channel_one_id}", None, False, True, False, False),
    # ("Moderator", "testflag {member_id}", None, False, False, True, False),
    ...
    # ("Moderator", "testunflag {member_id}", None, False, False, True, False),
    ...
    # ("Administrator", "alias vegan testvegan {voice_channel_one_id}", None, False, True, False, False),
    # ("Administrator", "alias carnist testcarnist {voice_channel_one_id}", None, False, True, False, False),
    # ("Moderator", "testvegan {member_id}", None, False, True, False, True),
    # ("Moderator", "ls {voice_channel_one_id}", None, False, True, False, False),
    ...
    # ("Moderator", "testcarnist {member_id}", None, False, True, False, True),
    # ("Moderator", "ls {voice_channel_one_id}", None, False, True, False, True),
    ...
    # ("Administrator", "alias vmute testvm {voice_channel_one_id}", None, False, True, False, False),
    # ("Administrator", "alias unvmute testunvm {voice_channel_one_id}", None, False, True, False, False),
    # ("Moderator", "testvm {member_id}", None, False, True, False, False),
    ...
    # ("Moderator", "testunvm {member_id}", None, False, True, False, False),
    ...
    # ("Administrator", "alias tmute testtm {voice_channel_one_id}", None, False, True, False, False),
    # ("Administrator", "alias untmute testuntm {voice_channel_one_id}", None, False, True, False, False),
    # ("Moderator", "testtm {member_id}", None, False, True, False, False),
    # ("Moderator", "tmutes {voice_channel_one_id}", None, False, True, False, False),
    ...
    # ("Moderator", "testuntm {member_id}", None, False, True, False, False),
