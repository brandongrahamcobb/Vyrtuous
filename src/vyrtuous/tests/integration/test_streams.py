...
COMMAND = "streams"
BASE_PERMISSIONS = ["command.info.streams"]
...
COLUMNS = [
    ...
    ("source_channel_snowflake", "bigint", True),
    ("source_guild_snowflake", "bigint", True),
...
async def test_streams_database_table(bot, field: str, datatype: str, nullable: bool):
