...
COMMAND = "mute"
BASE_PERMISSIONS = ["command.moderation.voice-mute", "other_channels"]
...
async def test_mute_app_command(
    bot,
    member: str,
    channel: str | None,
    group_alias: str,
    ...
    if (
        ...
        with ExitStack() as stack:
            ...
            command = cog.create_voice_mute_app_command
