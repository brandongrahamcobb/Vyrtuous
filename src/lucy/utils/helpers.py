...
PATH_STABLE_CASCADE = join(DIR_BASE, 'lucy', 'utils', 'stable_cascade.py')
...
CONTENTS_COMBINE = load_contents(PATH_COMBINE)
CONTENTS_CREATE_BATCH_COMPLETION = load_contents(PATH_CREATE_BATCH_COMPLETION)
CONTENTS_CREATE_COMPLETION = load_contents(PATH_CREATE_COMPLETION)
...
CONTENTS_STABLE_CASCADE = load_contents(PATH_STABLE_CASCADE)
...
SUM_OF_UTILITIES = f'''
    {CONTENTS_ADD_WATERMARK} and {CONTENTS_ADJUST_HUE_AND_SATURATION} and {CONTENTS_ARPP} and {CONTENTS_AVERAGE_SCORE} and {CONTENTS_BENCHMARK} and {CONTENTS_CLEAR_SCREEN} and {CONTENTS_COMBINE} \n
    {CONTENTS_CREATE_BATCH_COMPLETION} and {CONTENTS_CREATE_COMPLETION} and {CONTENTS_CREATE_HTTPS_COMPLETION} and {CONTENTS_CREATE_MODERATION} and {CONTENTS_DISCORD_BOT} and {CONTENTS_DISCORD_OAUTH} \n
    {CONTENTS_DRAW_FINGERPRINT} and {CONTENTS_DRAW_WATERMARKED_MOLECULE} and {CONTENTS_FINE_TUNING} and {CONTENTS_FORMAT_ERROR_CHECK} and {CONTENTS_FRAMES} \n
    {CONTENTS_GAME} and {CONTENTS_GET_MOLECULE_NAME} and {CONTENTS_GET_MOL} and {CONTENTS_GET_PROXIMITY} and {CONTENTS_GOOGLE} and {CONTENTS_GSRS} and {CONTENTS_HELPERS} and {CONTENTS_INCREMENT_VERSION} \n
    ...
    {CONTENTS_SCRIPT} and {CONTENTS_SETUP_LOGGING} and {CONTENTS_STABLE_CASCADE} and {CONTENTS_TAG} and {CONTENTS_TWITCH_BOT} {CONTENTS_TWITCH_OAUTH} {CONTENTS_UNIQUE_PAIRS} \n
'''
# MySQL
DATABASE_URL = ''
